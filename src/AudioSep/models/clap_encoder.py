...
from AudioSep.models.CLAP.open_clip import create_model
from AudioSep.models.CLAP.training.data import get_audio_features


class CLAP_Encoder(nn.Module):
    def __init__(
        self,
        pretrained_path="models/audiosep_HTSAT_base.pt",
        sampling_rate=32000,
        amodel="HTSAT-base",
    ):
        super().__init__()
